...
function page() {
  ...
  return (
    ...
    <div className="w-full bg-gray-900">
      <div className={`flex item-center justify-between max-sm:items-center max-sm:justify-between transition-all duration-300 fixed top-0 z-10 bg-black w-full py-6 px-20 max-sm:px-10  ${scrolled ? 'bg-transparent text-cyan-100 shadow-lg backdrop-blur-sm' : 'bg-transparent text-cyan-400'}`}>
